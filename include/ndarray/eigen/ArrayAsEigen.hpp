#ifndef NDARRAY_EIGEN_ArrayAsEigen_hpp_INCLUDED
#define NDARRAY_EIGEN_ArrayAsEigen_hpp_INCLUDED

/**
 *  @file ndarray/eigen/ArrayAsEigen.hpp
 *  @brief Custom Eigen matrix objects that present a view into an ndarray::Array.
 *
...
struct ei_traits< ndarray::EigenView<T,2,C> >{
...
template <typename T, int C>
struct ei_traits< ndarray::EigenView<T,1,C> >{
    typedef typename boost::remove_const<T>::type Scalar;
    enum {
...
template <typename T, int C>
struct ei_traits< ndarray::TransposedEigenView<T,2,C> >{
    typedef typename boost::remove_const<T>::type Scalar;
    enum {
        RowsAtCompileTime = Dynamic,
        ColsAtCompileTime = Dynamic,
...
template <typename T, int C>
struct ei_traits< ndarray::TransposedEigenView<T,1,C> >{
    typedef typename boost::remove_const<T>::type Scalar;
    enum {
        RowsAtCompileTime = 1,
...
#endif // !NDARRAY_EIGEN_ArrayAsEigen_hpp_INCLUDED
