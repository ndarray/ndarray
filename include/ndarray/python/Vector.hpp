#ifndef NDARRAY_PYTHON_Vector_hpp_INCLUDED
#define NDARRAY_PYTHON_Vector_hpp_INCLUDED

/** 
 *  @file ndarray/python/Vector.hpp 
...
#endif // !NDARRAY_PYTHON_Vector_hpp_INCLUDED
