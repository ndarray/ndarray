#ifndef NDARRAY_DETAIL_StridedIterator_hpp_INCLUDED
#define NDARRAY_DETAIL_StridedIterator_hpp_INCLUDED

/** 
 *  @file ndarray/detail/StridedIterator.hpp
 *
...
#endif // !NDARRAY_DETAIL_StridedIterator_hpp_INCLUDED
