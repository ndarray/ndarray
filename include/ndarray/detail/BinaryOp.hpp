#ifndef NDARRAY_DETAIL_BinaryOp_hpp_INCLUDED
#define NDARRAY_DETAIL_BinaryOp_hpp_INCLUDED

/** 
 *  @file ndarray/detail/BinaryOp.hpp
 *
...
#endif // !NDARRAY_DETAIL_BinaryOp_hpp_INCLUDED
