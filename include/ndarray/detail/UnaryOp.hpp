#ifndef NDARRAY_DETAIL_UnaryOp_hpp_INCLUDED
#define NDARRAY_DETAIL_UnaryOp_hpp_INCLUDED

/** 
 *  @file ndarray/detail/UnaryOp.hpp
 *
...
#endif // !NDARRAY_DETAIL_UnaryOp_hpp_INCLUDED
