#ifndef LSST_NDARRAY_ExpressionBase_hpp_INCLUDED
#define LSST_NDARRAY_ExpressionBase_hpp_INCLUDED

/** 
 *  @file lsst/ndarray/ExpressionBase.hpp
 *
...
#endif // !LSST_NDARRAY_ExpressionBase_hpp_INCLUDED
