 ...
 */
#ifndef LSST_NDARRAY_DETAIL_StridedIterator_h_INCLUDED
#define LSST_NDARRAY_DETAIL_StridedIterator_h_INCLUDED

/** 
 *  @file lsst/ndarray/detail/StridedIterator.h
 *
...
#endif // !LSST_NDARRAY_DETAIL_StridedIterator_h_INCLUDED
