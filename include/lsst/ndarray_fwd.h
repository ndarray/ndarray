#ifndef LSST_NDARRAY_ndarray_fwd_hpp_INCLUDED
#define LSST_NDARRAY_ndarray_fwd_hpp_INCLUDED

/**
 * @file lsst/ndarray_fwd.hpp 
 *
...
#endif // !LSST_NDARRAY_ndarray_fwd_hpp_INCLUDED
